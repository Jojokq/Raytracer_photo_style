...
class quad: public hittable {
    ...
    public:
        ...
        bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
            ...
            //Determing if the hit point lies within the planar shape
            ...
            //Ray hits shape, set the rest of the hit record 
            rec.t = t;
            rec.p = intersection;
            rec.mat = mat;
            rec.set_frame_normal(r, normal);
...
inline shared_ptr<hittable_list> box(const point3& a, const point3& b, shared_ptr<material> mat) {
    //Returns 3D box that contains two opposite vertices a&b
